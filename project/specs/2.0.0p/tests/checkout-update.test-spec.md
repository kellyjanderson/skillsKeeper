# Checkout Update Test Specification

Date: 2026-07-17
Status: Reviewed Draft
Feature spec: `project/specs/2.0.0p/checkout-update.spec.md`
...
Verifies the route and helper behavior for refresh generated checkout copies and pinned hashes only when the user explicitly invokes checkout update.
...
- Exercise `skillskeeper checkout update --workspace <path>` against a temporary datastore/workspace fixture and confirm the observable result without touching production state.
