# SkillsKeeper 2.0.0p Specifications

Status: Reviewed draft leaves created. Ready for implementation planning after user acceptance.

Source release: `project/releases/2.0.0p.md`
...
- `project/spec-refinement-history/2.0.0p-20260717-190429.md`
- `project/spec-refinement-history/2.0.0p-architecture-crosscheck-20260717-194042.md`
